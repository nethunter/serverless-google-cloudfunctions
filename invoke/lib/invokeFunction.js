...
module.exports = {
  ...
  invoke() {
    ...
    func = getGoogleCloudFunctionName(this.serverless.service.functions, func, stage);
...
const getGoogleCloudFunctionName = (serviceFunctions, func, stage) => {
  ...
  return `${stage}-${serviceFunctions[func].handler}`;
};
